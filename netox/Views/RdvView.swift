            ...
            ZStack (alignment: .topLeading) {
                ...
                VStack {
                    VStack (spacing: 40) {
                        ...
                        VStack (spacing: 20){
                            VStack (spacing: 30){
                                CustomTextField(placeHolder: "Date", imageName: "calendar", bColor: "textcolor2", tOpacity: 1.0, value: $date)
                                CustomTextField(placeHolder: "Heure", imageName: "clock", bColor: "textcolor2", tOpacity: 1.0, value: $heure)
